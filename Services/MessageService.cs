...
namespace BlazorChat.Services 
{
    public class MessageService : IMessageService
    {
        ...
        public MessageService(IDbContextFactory<ApplicationDbContext> factory) => _factory = factory;

        public async Task<MessageDto> SaveGroupMessageAsync(string senderId, string groupId, string content)
        {
        ...
        public async Task<MessageDto> SaveDirectMessageAsync(string senderId, string recipientId, string content)
        {
            await using var db = await _factory.CreateDbContextAsync();
